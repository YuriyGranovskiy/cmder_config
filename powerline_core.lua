...
function addArrow(text, oldColor, newColor)
	...
	text = addTextWithColor(text, plc_prompt_arrowSymbol, oldColor, newColor)
	return text
end 
...
function addTextWithColor(text, textToAdd, textColorValue, fillColorValue)	
	local textColorCode = ""
	if textColorValue == "0" then
		textColorCode = "30"
	else
		textColorCode = "2;"..textColorValue
	end

	local fillColorCode = ""
	if fillColorValue == "0" then
		fillColorCode = "40"
	else
		fillColorCode = "2;"..fillColorValue
	end
	...
	text = text..ansiEscChar.."[38;"..textColorCode..";48;"..fillColorCode.."m"..textToAdd..ansiEscChar.."[0m"
	return text 
end 
...
function addSegment(text, textColor, fillColor) 	
	...
	newPrompt = addTextWithColor(newPrompt, text, textColor, fillColor)
	-- Write the closing arrow
	newPrompt = addArrow(newPrompt, fillColor, defaultColor)
